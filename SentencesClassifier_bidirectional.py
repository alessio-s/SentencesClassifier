...
# Pplit the data into a training set and a validation set
...
left.add(LSTM(lstm_units, activation='sigmoid', input_shape=(x_train.shape[0], x_train.shape[1])))

right = Sequential()
right.add(embedding_layer)
right.add(LSTM(lstm_units, activation='sigmoid', input_shape=(x_train.shape[0], x_train.shape[1]), go_backwards=True))
